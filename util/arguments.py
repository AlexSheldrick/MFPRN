...
def parse_arguments():
    ...
    parser.add_argument('--val_check_percent', type=float, default=0.02, help='percentage of val checked')
    ...
    parser.add_argument('--clamp', type=float, default=-1, help='truncate sdf to certain value or convert to occupancy field')
