...
def parse_arguments():
    ...
    parser.add_argument('--resume', type=str, default='/media/alex/SSD Datastorage/guided-research/runs/sdf/17090300_Full_SDF_Ablation_128_DynamicDepth_DENSITY_&augmentations_hybrid/checkpoints/epoch=390-val_loss=0.0910.ckpt', help='resume checkpoint')
    ...
    parser.add_argument('--experiment', type=str, default='Ablation9_GRAD&SDF_RGB_surface', help='experiment directory')
